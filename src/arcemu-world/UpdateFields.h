...
{
    OBJECT_DYNAMIC_FLAGS_END                                 = OBJECT_DYNAMIC_END + 0x000,
};
...
// 6.x -- !!! check all of them !!!
#define PLAYER__FIELD_KNOWN_TITLES1 PLAYER__FIELD_KNOWN_TITLES + 1 // not sure
#define PLAYER__FIELD_KNOWN_TITLES2 PLAYER__FIELD_KNOWN_TITLES + 1 // not sure

#define PLAYER_VISIBLE_ITEM_19_ENTRYID     PLAYER_VISIBLE_ITEM + 19 + VISIBLE_ITEM_ENTRY_OFFSET // not sure
#define PLAYER_VISIBLE_ITEM_19_ENCHANTMENT PLAYER_VISIBLE_ITEM + 19 + VISIBLE_ITEM_ENCHANTMENT_OFFSET // not sure

#define PLAYER_QUEST_LOG_25_5              PLAYER_QUEST_LOG + 99 // not sure
#define PLAYER_QUEST_LOG_25_1              PLAYER_QUEST_LOG + 94 // not sure

#define UNIT_FIELD_STAT0           UNIT_FIELD_STAT
#define UNIT_FIELD_STAT1           UNIT_FIELD_STAT + 1
#define UNIT_FIELD_STAT2           UNIT_FIELD_STAT + 2
#define UNIT_FIELD_STAT3           UNIT_FIELD_STAT + 3
#define UNIT_FIELD_STAT4           UNIT_FIELD_STAT + 4

#define UNIT_FIELD_STRENGTH        UNIT_FIELD_STAT
#define UNIT_FIELD_AGILITY         UNIT_FIELD_STAT + 1
#define UNIT_FIELD_STAMINA         UNIT_FIELD_STAT + 2
#define UNIT_FIELD_INTELLECT       UNIT_FIELD_STAT + 3
#define UNIT_FIELD_SPIRIT          UNIT_FIELD_STAT + 4

#define UNIT_FIELD_POSSTAT0        UNIT_FIELD_POSSTAT
#define UNIT_FIELD_POSSTAT1        UNIT_FIELD_POSSTAT + 1
#define UNIT_FIELD_POSSTAT2        UNIT_FIELD_POSSTAT + 2
#define UNIT_FIELD_POSSTAT3        UNIT_FIELD_POSSTAT + 3
#define UNIT_FIELD_POSSTAT4        UNIT_FIELD_POSSTAT + 4

#define UNIT_FIELD_NEGSTAT0        UNIT_FIELD_NEGSTAT
#define UNIT_FIELD_NEGSTAT1        UNIT_FIELD_NEGSTAT + 1
#define UNIT_FIELD_NEGSTAT2        UNIT_FIELD_NEGSTAT + 2
#define UNIT_FIELD_NEGSTAT3        UNIT_FIELD_NEGSTAT + 3
#define UNIT_FIELD_NEGSTAT4        UNIT_FIELD_NEGSTAT + 4

#define UNIT_FIELD_POWER1          UNIT_FIELD_POWER        // mana
#define UNIT_FIELD_POWER2          UNIT_FIELD_POWER + 1    // rage
#define UNIT_FIELD_POWER3          UNIT_FIELD_POWER + 2    // focus
#define UNIT_FIELD_POWER4          UNIT_FIELD_POWER + 3    // energy points
#define UNIT_FIELD_POWER5          UNIT_FIELD_POWER + 4    //
#define UNIT_FIELD_POWER6          UNIT_FIELD_POWER + 5    //
#define UNIT_FIELD_POWER7          UNIT_FIELD_POWER + 6    // runic power -- not sure about this one

// not sure about these ones
#define UNIT_FIELD_MAXPOWER1       UNIT_FIELD_MAXPOWER
#define UNIT_FIELD_MAXPOWER2       UNIT_FIELD_MAXPOWER + 1
#define UNIT_FIELD_MAXPOWER3       UNIT_FIELD_MAXPOWER + 2
#define UNIT_FIELD_MAXPOWER4       UNIT_FIELD_MAXPOWER + 3
#define UNIT_FIELD_MAXPOWER5       UNIT_FIELD_MAXPOWER + 4
#define UNIT_FIELD_MAXPOWER6       UNIT_FIELD_MAXPOWER + 5

//VLack: Don't forget to fix up these when generating this file from a new client!!!
//#define PLAYER_VISIBLE_ITEM_LENGTH                (PLAYER_VISIBLE_ITEM_2_ENTRYID - PLAYER_VISIBLE_ITEM + VISIBLE_ITEM_ENTRY_OFFSET)
