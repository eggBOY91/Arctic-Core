...
#define PLAYER_VISIBLE_ITEM_19_ENTRYID     PLAYER_VISIBLE_ITEM + 19 // not sure
#define PLAYER_VISIBLE_ITEM_19_ENCHANTMENT PLAYER_VISIBLE_ITEM + 19 + VISIBLE_ITEM_ENTRY_OFFSET // not sure
