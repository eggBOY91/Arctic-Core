...
#define UNIT_FIELD_AGILITY                        UNIT_FIELD_STAT
#define UNIT_FIELD_STAMINA                        UNIT_FIELD_STAT
#define UNIT_FIELD_INTELLECT                      UNIT_FIELD_STAT
#define UNIT_FIELD_SPIRIT                         UNIT_FIELD_STAT
